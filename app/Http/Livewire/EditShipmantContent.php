...
class EditShipmantContent extends Component
{
    ...
    public function addbolContent()
    {
        ...
        $this->bolContents[] = [
            'content_id' => $this->billoflading->id,
            'billoflading_id' => $this->billoflading->id,
            'containerNo' => '',
            'qty' => 1,
            'seal' => '',
            'shipmenttype' => '',
    ...
    {
        $content = $this->bolContents[$index] ?? NULL;
        $removeContent = Content::find($content['content_id']);
    ...
    public function render()
    {
        ...
        return view('livewire.edit-shipmant-content', [
